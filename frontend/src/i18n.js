...
const messages = {
  en: {
    ...
    builtBy: 'Built by', returnOperation: 'Return to an operation',
  ...
  es: {
    ...
    builtBy: 'Creado por', returnOperation: 'Volver a una operación',
  ...
  fr: {
    ...
    builtBy: 'Créé par', returnOperation: 'Revenir à une opération',
  ...
  it: {
    ...
    builtBy: 'Creato da', returnOperation: 'Torna a un’operazione',
  ...
  zh: {
    ...
    builtBy: '开发者', returnOperation: '返回行动',
  ...
  ru: {
    ...
    builtBy: 'Автор', returnOperation: 'Вернуться к операции',
  ...
  he: {
    ...
    builtBy: 'נבנה על ידי', returnOperation: 'חזרה למבצע',
